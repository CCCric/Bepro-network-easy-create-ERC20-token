...
var _ipfsHttpClient = require('ipfs-http-client');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/**
                                                                                                                                                 ...
                                                                                                                                                 */var
DexStorage = function () {
  function DexStorage() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { ipfsClientHTTP: { host: 'ipfs.infura.io', port: 5001, protocol: 'https' } },ipfsClientHTTP = _ref.ipfsClientHTTP;(0, _classCallCheck3.default)(this, DexStorage);
    if (!ipfsClientHTTP) {
      throw new Error("Please provide a valid ipfsClientHTTP, you can find one at infura.io");
    }
    this.ipfs = (0, _ipfsHttpClient.create)(ipfsClientHTTP);
  }
  ...
  /**
     ...
     */(0, _createClass3.default)(DexStorage, [{ key: 'save', value: function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref3) {var
        data = _ref3.data;var _ref4, path, cid, size;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  this.ipfs.add(data));case 2:_ref4 = _context.sent;path = _ref4.path;cid = _ref4.cid;size = _ref4.size;return _context.abrupt('return',
                { path: path, cid: cid, size: size });case 7:case 'end':return _context.stop();}}}, _callee, this);}));function save(_x2) {return _ref2.apply(this, arguments);}return save;}()
    ...
    /**
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 */ }, { key: 'get', value: function () {var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(_ref6) {var _this = this;var
        cid = _ref6.cid;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:return _context3.abrupt('return',
